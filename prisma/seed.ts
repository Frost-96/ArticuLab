...
const scenarios: ScenarioSeed[] = [
  {
    ...
    prompt:
      "Some people believe remote work improves productivity, while others think it harms teamwork. Discuss both views and give your opinion.",
    difficulty: "medium",
  },
  {
    key: "writing-daily",
    ...
    prompt:
      "Write a short reflection email to your manager about what you learned from your latest team project and what support would help you improve further.",
    difficulty: "easy",
  },
  {
    ...
    prompt:
      "Act as a hiring manager interviewing a candidate for a product designer role. Ask focused follow-up questions and encourage specific examples.",
  ...
  },
  {
    ...
    prompt:
      "Act as a hotel front desk agent helping a traveler whose room booking has a mistake. Keep the conversation practical and natural.",
...
const writingExercises: WritingExerciseSeed[] = [
  ...
  },
  {
    ...
    feedback: buildWritingFeedback({
      ...
      improvements: ["Keep building a wider range of workplace expressions."],
    }),
...
const speakingExercises: SpeakingExerciseSeed[] = [
        ...
        suggestedVocabulary: [
          {
            ...
            definition: "involving several different teams or departments",
            exampleSentence:
      ...
      expressionSuggestions: [
        {
          ...
          improved: "I collaborated closely with cross-functional stakeholders",
          explanation:
  ...
  },
  {
      ...
      grammarErrors: [
        {
          ...
          explanation: "The singular subject booking needs the verb says.",
        },
      ],
      vocabularyAnalysis: {
        ...
        suggestedVocabulary: [
          {
            ...
            exampleSentence: "Could you check availability for a quieter room?",
          },
        ],
      },
      expressionSuggestions: [
    ...
    messages: [
      {
        role: "assistant",
        content: "Good evening. Welcome to the hotel. How may I help you?",
        createdAt: daysAgo(13, 16, 30),
  ...
  },
  {
    ...
    feedback: buildSpeakingFeedback({
      ...
      grammarErrors: [
        {
          original: "That project help me understand stakeholder needs faster.",
          corrected:
      ...
      vocabularyAnalysis: {
        ...
        suggestedVocabulary: [
          {
            word: "trade-off",
            definition: "a balance between two competing priorities",
            exampleSentence:
      ...
      expressionSuggestions: [
        {
          ...
          improved: "we reached alignment after reviewing the trade-offs",
          explanation: "This sounds more polished and interview-ready.",
        },
      ],
      strengths: [
    ...
    messages: [
      ...
      {
        role: "assistant",
        content: "How did you persuade them to accept the simpler version?",
  ...
  },
  {
    ...
    messages: [
      ...
      {
        role: "assistant",
        content: "No problem. May I see your passport and booking number?",
  ...
  for (const [index, conversation] of coachConversations.entries()) {
    await db.conversation.create({
      data: {
        ...
        messages: {
          create: conversation.messages.map((message, messageIndex) => ({
