 ...
 */
export async function getSpeakingScenarioTypesAction(): Promise<
  ActionResult<ScenarioType[]>
> {
  try {
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Failed to get speaking scenario types",
    };
  }
}
 ...
 * @returns ActionResult<ScenarioType[]>
 */
export async function getWritingScenarioTypesAction(): Promise<
  ActionResult<ScenarioType[]>
> {
  try {
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Failed to get writing scenario types",
    };
  }
}
