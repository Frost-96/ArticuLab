...
type EmailVerificationRecord = NonNullable<
  Awaited<ReturnType<typeof emailVerificationRepo.findEmailVerificationById>>
>;
...
export async function createEmailVerification(
  ...
  const emailVerification = await emailVerificationRepo.createEmailVerification(
    parsedInput.data,
  );
...
export async function getEmailVerification(
  ...
  const emailVerification =
    await emailVerificationRepo.findEmailVerificationById(parsedInput.data.id);
