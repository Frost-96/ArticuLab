...
// 创建写作练习
export const createWritingExerciseSchema = z
  .object({
    scenarioType: writingScenarioTypeEnum,
    prompt: z
      .string()
  ...
  .refine(
    ...
    },
    {
      // 这里的 message 就是报错信息
      message:
        "scenarioId is required for non-custom prompts and cannot be included with custom prompts.",
...
export type CreateWritingExerciseInput = z.infer<
  typeof createWritingExerciseSchema
>;
export type GetDraftInput = z.infer<typeof getDraftSchema>;
export type DeleteWritingExerciseInput = z.infer<
  typeof deleteWritingExerciseSchema
>;
export type RenameWritingExerciseInput = z.infer<
  typeof renameWritingExerciseSchema
>;
