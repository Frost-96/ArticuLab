      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            A quick look at how ArticuLab supports the practice, feedback,
    ...
    <div className="animate-scale-in overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
      <div className="border-b border-slate-100 px-6 py-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-sm text-slate-500">Marketing Manager Role</span>
        </div>
      </div>
      ...
      <div className="space-y-4 p-6">
        <div className="flex gap-3">
          ...
          <div className="max-w-[80%] rounded-lg bg-slate-50 px-4 py-3">
            <p className="text-sm leading-6 text-slate-700">
              Tell me about a time when you handled a challenging client
        ...
        <div className="flex flex-row-reverse gap-3">
          ...
          <div className="max-w-[80%] rounded-lg bg-sky-50 px-4 py-3">
            <p className="text-sm leading-6 text-slate-700">
              Sure. In my previous role, I had a client who was unhappy with our
              campaign results, so I scheduled a meeting to...
            </p>
          ...
          <div className="max-w-[85%] space-y-3 rounded-lg bg-slate-50 px-4 py-3">
            ...
            <div className="rounded-lg border border-blue-100 bg-blue-50 p-3">
              <p className="text-sm text-blue-800">
                <strong>Affect</strong> is usually a verb that means to
                influence something.
              </p>
            ...
            <div className="rounded-lg border border-emerald-100 bg-emerald-50 p-3">
              <p className="text-sm text-emerald-800">
                <strong>Effect</strong> is usually a noun that means the result
                of a change.
              </p>
