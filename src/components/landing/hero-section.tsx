      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
            A focused writing, speaking, and AI coaching platform for learners
            preparing for IELTS, TOEFL, and academic English.
          </p>
              ...
              <div className="min-w-0 p-4 sm:p-5">
                ...
                <div className="mt-4 rounded-md border border-slate-200 bg-white p-4">
                  <p className="text-sm leading-7 text-slate-700">
                    ...
                    that it improves access to education, others believe it{" "}
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-md border border-amber-200 bg-amber-50 p-3">
                    ...
                    <p className="mt-2 text-sm leading-6 text-amber-950">
                      Replace broad phrases with more precise academic wording.
                    </p>
                  </div>
                  <div className="rounded-md border border-blue-200 bg-blue-50 p-3">
                    ...
                    <p className="mt-2 text-sm leading-6 text-blue-950">
                      Write one paragraph focused on concession and contrast.
                    </p>
                  </div>
                </div>
              </div>
