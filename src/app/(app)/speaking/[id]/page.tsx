...
export default function SpeakingSessionPage() {
    ...
    const { currentSpeakingSession } = useSpeakingStore();
        ...
        <div className="flex flex-col h-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-medium text-slate-900">
                            {currentSpeakingSession?.title ||
                                "Speaking Practice"}
                        </h1>
                        <p className="text-xs text-slate-400">
                            {currentSpeakingSession?.aiRole || "AI Coach"} •
                            Live session
                        </p>
                    </div>
                </div>
            ...
            <div className="border-t border-slate-200 bg-white p-4 shrink-0">
                ...
                <p className="text-xs text-slate-400 text-center mt-2">
                    Press Enter to send • Shift+Enter for new line • Click mic
                    to record
                </p>
            </div>
        </div>
