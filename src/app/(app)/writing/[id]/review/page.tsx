...
export default function Page() {
    ...
    // Score Row Component
    const { currentWritingSession } = useWritingStore();
                ...
                <p className="text-slate-700 leading-relaxed">
                    {pIndex === 0 && (
                        <>
                            ...
                            part of our daily lives. Some people believe that
                            this has made our lives more complex, while others
                            argue that it has simplified many aspects of living.{" "}
                            <span
                            ...
                            , although technology has introduced some new
                            challenges, it has overall made our lives easier and
                            more convenient.
                        </>
                    )}
                    {pIndex === 1 && (
                        <>
                            ...
                            the way we communicate. In the past, sending a
                            letter could take days or even weeks, but now we can
                            instantly connect with anyone around the world
                            through email, messaging apps, or video calls. This
                            has made it easier for people to stay in touch with
                            family and friends, regardless of geographical
                            distance. Furthermore, social media platforms have
                            enabled us to build and maintain broader networks of
                            relationships.
                        </>
                    )}
                    {pIndex === 2 && (
                        <>
                            Secondly, technology has greatly improved access to
                            information and education. The internet provides a{" "}
                            <span
                                className="bg-yellow-100 text-yellow-700 px-1 rounded cursor-help"
                            ...
                            repository of knowledge that is available at our
                            fingertips. Students can now access online courses,
                            tutorials, and educational resources from
                            prestigious universities around the world. This
                            democratization of knowledge has made quality
                            education more accessible to people regardless of
                            their socioeconomic background or location.
                        </>
                    )}
                    {pIndex === 3 && (
                        <>
                            ...
                            to ignore the potential downsides of technology. The
                            constant connectivity can lead to information
                            overload and decreased attention spans. Many people
                            find themselves constantly checking their phones,
                            which can be distracting and reduce productivity.
                            Additionally,{" "}
                            <span
                                className="bg-emerald-100 text-emerald-700 px-1 rounded cursor-help"
                                title="Correct usage"
                            ...
                            concerns about privacy and the security of personal
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-3 rounded-lg bg-emerald-50 border border-emerald-200">
                                ...
                                <p className="text-sm text-emerald-700">
                                    Technology has significantly enhanced our
                                    quality of life by streamlining daily tasks
