 ...
 * - WRITING_SCENARIO_TYPES：写作类 WritingScenarioType 列表
 * - SPEAKING_SCENARIO_TYPES：口语类 ScenarioType 列表
 * - scoreRangeForScenarioType：返回 [min, max]，雅思 0–9，托福 0-5，四六级 0–100，其余默认 0–9
 */

export const MIN_WORDS = 50;
export const MAX_WORDS = 2000;

/* export const EXAM_SCENARIO_TYPES: readonly WritingScenarioType[] = [
  "ielts_task1",
  "ielts_task2",
  "toefl",
  "cet4",
...
export const DAILY_SCENARIO_TYPE: WritingScenarioType = "daily";

export const WRITING_SCENARIO_TYPES: readonly WritingScenarioType[] = [
  "ielts_task1",
  "ielts_task2",
  "toefl",
  "cet4",
...
export const SPEAKING_SCENARIO_TYPES: readonly string[] = [
  "interview",
  "travel",
  "business",
] as const;
